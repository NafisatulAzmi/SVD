...
# set repo
wget -O /etc/apt/sources.list https://raw.githubusercontent.com/stylersnico/debian-scripts/master/ovh/sources.list
...
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/NafisatulAzmi/SVD/master/nginx.conf 
mkdir -p /home/vps/public_html
echo "<pre>Modified by Pa'an Finest</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf https://raw.githubusercontent.com/NafisatulAzmi/SVD/master/vps.conf 
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf
service php5-fpm restart
service nginx restart

PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false paan
echo "paan:$PASS" | chpasswd
echo "finest" >> pass.txt
echo "$PASS" >> pass.txt
...
# install mrtg
wget -O /etc/snmp/snmpd.conf https://raw.githubusercontent.com/NafisatulAzmi/SVD/master/snmpd.conf 
wget -O /root/mrtg-mem.sh https://raw.githubusercontent.com/NafisatulAzmi/SVD/master/mrtg-mem.sh 
...
curl "https://raw.githubusercontent.com/NafisatulAzmi/SVD/master/mrtg.conf" >> /etc/mrtg.cfg
...
# install pptp vpn
wget https://raw.githubusercontent.com/NafisatulAzmi/SVD/master/pptp.sh 
chmod +x pptp.sh
./pptp.sh 
...
echo "Pilihan Menu Pada Setup VPS Finest Media :" | tee -a log-install.txt
...
echo "Script Created By Pa'an Finest" | tee -a log-install.txt
echo "Thanks To Finest Media - Phreakers Jateng" | tee -a log-install.txt
